...
public class Racecar extends Sprite {
	...
	/**
	 * getInitialX() is a methods that provides the position where the racecar 
	 ...
	 * the racecar is a hazard to the player, and the speed of the racecar.
	 */
	...
	/**
	 * update() updates the racecar's coordinates and ensures that if the racecar is 
	 * on  a trajectory to go beyond the screen, it reappears  on the other side by 
